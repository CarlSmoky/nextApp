      ...
      {links.map((link: LinkInfo, i) => (
        <div key={i}>
          <div className="text-left md:cursor-pointer group">
            <h1
              className={`py-7 px-3 lg:px-2 flex justify-between align-baseline text-grey-200 text-base xl:text-lg uppercase font-paragraph hover:text-black-100 transition-all duration-300 ease-in-out ${navContext?.currentNav ===  link.navState ? 'underline underline-offset-4' : ""}`}
            >
