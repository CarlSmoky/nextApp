...
const ImageLinkAnimation: React.FC<Props> = ({ src, alt }: Props)=> {
  return (
    <div className="flex items-center justify-center from-teal-100 via-teal-300 to-teal-500 bg-gradient-to-br">
      <div className="overflow-hidden aspect-video md:aspect-square bg-red-400 cursor-pointer rounded-lg relative group shadow-2xl">
        <div className="rounded-lg z-50 opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out cursor-pointer absolute from-black-100/80 to-transparent bg-gradient-to-t inset-x-0 -bottom-2 pt-30 text-white-100 flex items-end ">
          <div>
