    ...
    >
      <div className="flex from-teal-100 via-teal-300 to-teal-500 bg-gradient-to-br shadow-2xl cursor-pointer">
        <div className="relative w-full aspect-video sm:aspect-square overflow-hidden group">
          <div className="absolute z-10 opacity-100 lg:opacity-0 lg:group-hover:opacity-100 group-active:opacity-40 lg:group-active:opacity-40 transition duration-300 ease-in-out from-black-100/80 to-transparent group-active:to-black-100/80 bg-gradient-to-t inset-x-0 -bottom-2 group-active:top-0 pt-30 text-white-100 flex items-end">
