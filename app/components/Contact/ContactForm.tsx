...
const ContactForm = () => {
  return (
    <div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto shadow-2xl text-grey-100">
      <div className="flex">
      ...
      <div className="my-4 font-paragraph">
        <textarea
          placeholder="Message*"
          className="w-full h-32 bg-gray-100 text-gray-200 mt-2 p-3 focus:outline-none focus:shadow-outline caret-grey-100/70"
        ></textarea>
      </div>
